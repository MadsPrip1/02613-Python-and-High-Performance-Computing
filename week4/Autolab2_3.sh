...
kernprof -l  python_performance_optim.py /dtu/projects/02613_2025/data/locations/locations_100.csv 
### python -m line_profiler python_performance_optim.py /dtu/projects/02613_2025/data/locations/locations_100.csv 
